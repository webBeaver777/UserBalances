      ...
      <div class="col-12">
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
              <li class="breadcrumb-item">
                <router-link to="/balance" class="text-decoration-none">Главная</router-link>
              </li>
        ...
        <div class="card shadow-sm mb-4">
          <div class="card-body">
            <div class="row g-3">
              <div class="col-md-6">
                <label for="searchInput" class="form-label">Поиск по описанию</label>
                <input
                  id="searchInput"
                  v-model="searchQuery"
                  type="text"
              ...
              <div class="col-md-3">
                ...
                <select v-model="sortDirection" @change="handleSortChange" class="form-select">
        ...
        <div class="card shadow-sm" style="border: 2px solid #e91e63;">
          ...
          <div class="card-body p-0">
            ...
            <div v-else-if="operationStore.operations.length === 0" class="text-center text-muted py-4">
              {{ searchQuery ? `По запросу "${searchQuery}" ничего не найдено` : 'Нет операций для отображения' }}
            </div>
            <div v-else>
                ...
                <table class="table mb-0">
                  ...
                  <tbody>
                    <tr v-for="operation in operationStore.operations" :key="operation.id">
                      ...
                      <td>
                        <span v-if="searchQuery" v-html="highlightSearch(operation.description)"></span>
                        <span v-else>{{ operation.description || '—' }}</span>
                      </td>
                      <td class="text-nowrap">{{ formatDate(operation.created_at) }}</td>
                      <td>
              ...
              <div v-if="operationStore.totalPages > 1" class="card-footer bg-light">
